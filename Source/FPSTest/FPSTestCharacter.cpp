...
{
	OnServerFire();//send a request to the server for function output
	//take local firing and making it a server function
...
void AFPSTestCharacter::OnServerFire_Implementation()
{
...
bool AFPSTestCharacter::OnServerFire_Validate()
{
	return true;
}
...
void AFPSTestCharacter::Tick(float DeltaTime)
{
	...
	{
		FRotator NewRot = Mesh1P->GetRelativeRotation();
